...
insert into ticket(user_id, fixture, bets) values(1,30, 'Good');
insert into ticket(user_id, fixture, bets) values(2,300, 'Middle');
insert into ticket(user_id, fixture, bets) values(3,-30, 'Bad');
